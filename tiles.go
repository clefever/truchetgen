...
func Tile3(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Line(x+size/4, y+size/2, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
}

func Tile4(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
...
func Tile5(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	DrawDots(canvas, x, y, size, false)
}

func Tile6(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size/4, size/4, size/4, 0, false, false, x+size-size/4, y+size/2, style)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, false, x+size/4, y+size/2, style)
...
func Tile7(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Line(x+size/4, y+size/2, x+size-size/4, y+size/2, style)
	canvas.Line(x+size/2, y+size/4, x+size/2, y+size-size/4, style)
...
func Tile8(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size/4, size/4, size/4, 0, false, false, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile9(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, false, x+size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile10(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size/4, size/4, size/4, 0, false, true, x+size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile11(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, true, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile12(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size/4, size/4, size/4, 0, false, false, x+size-size/4, y+size/2, style)
	canvas.Arc(x+size/2, y+size/4, size/4, size/4, 0, false, true, x+size/4, y+size/2, style)
...
func Tile13(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, true, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile14(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, true, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
...
func Tile15(canvas *svg.SVG, x int, y int, size int) {
	DrawBase(canvas, x, y, size, false)
	style := fmt.Sprintf("fill:%s;stroke:%s;stroke-width:%d", "none", "black", size/6)
	canvas.Arc(x+size/2, y+size-size/4, size/4, size/4, 0, false, true, x+size-size/4, y+size/2, style)
	DrawDots(canvas, x, y, size, false)
